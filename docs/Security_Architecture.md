...
## 12) Quality assurance & red‑team testing

- Maintain a school‑specific **prompt pack** covering curricular contexts (history/PSHE), pastoral scenarios (self‑harm disclosures), and adversarial tests (jailbreaks, indirect prompts in PDFs/links). Validate expected outcomes after every model or policy change ([Prompt Shields concept](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/jailbreak-detection)).  
- Include **training language coverage** considerations; outcomes may vary by language—plan extra tests for community languages used in your school ([Harm categories & severity levels](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/content-filter-severity-levels?view=foundry-classic)).

---

## 13) Operating model (roles & RACI)

- **DSL**: Owns safety requirements, receives escalations, reviews monthly safety reports, and leads annual effectiveness review per DfE standard ([DfE core standard](https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/filtering-and-monitoring-core-standard)).  
- **IT/Platform**: Manages Foundry policies, deployments, telemetry, and break‑glass procedures; implements Prompt Shields and RAG sanitization ([Prompt Shields concept](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/jailbreak-detection)).  
- **Teachers/Staff**: Use the app within age‑appropriate profiles; report anomalies.  
- **Governance**: SLT/Governors ensure policy review and resourcing; evidence readiness for inspection ([DfE core standard](https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/filtering-and-monitoring-core-standard)).
...
- Stand up Foundry project; deploy chosen models; attach **Students‑Default** and **Staff‑Moderated** filter configs; enable Prompt Shields, Protected Material, Groundedness ([Configure content filters – how to](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/content-filters?view=foundry-classic), [Prompt Shields studio](https://ai.azure.com/explore/contentsafety/prompt-shields), [Content Safety explore](https://ai.azure.com/explore/contentsafety)).  
- Integrate safety system message templates ([Content Safety explore](https://ai.azure.com/explore/contentsafety)).

**Phase 2 – Integrations & RAG (Weeks 4–6)**  
- Add RAG data sources; **run Prompt Shields on documents**; wire groundedness to UI (show citations; block ungrounded) ([Prompt Shields concept](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/jailbreak-detection), [Content Safety explore](https://ai.azure.com/explore/contentsafety)).  
- Implement telemetry and alerting for blocked categories.

**Phase 3 – QA & Safeguarding (Weeks 7–9)**  
- Red‑team with the school prompt pack; certify outcomes; finalize DPIA (include Microsoft data‑handling references) ([Abuse monitoring](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/abuse-monitoring?view=foundry-classic)).

**Phase 4 – Go‑live & Review (Weeks 10–12)**  
- Staff/DSL briefing; publish incident playbooks; set review cadence; prepare DfE/KCSIE evidence pack ([DfE core standard](https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/filtering-and-monitoring-core-standard), [KCSIE](https://www.gov.uk/government/publications/keeping-children-safe-in-education--2)).

---

## 15) Appendix: Key Microsoft capabilities you’ll rely on
...
By using Microsoft’s first‑party safety stack **end‑to‑end**—and documenting your thresholds, exceptions, and reviews—you achieve **stronger real‑world protection** for pupils with less operational risk than bespoke classifiers, while meeting **DfE/KCSIE** expectations for appropriate filtering and leadership oversight.
