...
school_name = "MySchool AI Assistant"
alert_email = "admin@myschool.edu"  # REPLACE WITH YOUR SCHOOL IT EMAIL

# Azure AI Foundry Configuration (Enhanced for Schools)
ai_foundry_name      = "schoolgptaifoundry123"    # MUST BE GLOBALLY UNIQUE
ai_foundry_subdomain = "schoolgptai123"           # MUST BE GLOBALLY UNIQUE
...
acr_name              = "schoolgptacr123"         # MUST BE GLOBALLY UNIQUE
app_service_plan_name = "schoolgpt-asp"
app_service_sku       = "B2"                     # B1/B2/B3 for basic, S1/S2/S3 for standard
web_app_name          = "schoolgpt-webapp123"    # MUST BE GLOBALLY UNIQUE
...
sql_server_name       = "schoolgptsqlsrv123"     # MUST BE GLOBALLY UNIQUE
sql_admin             = "sqladminuser"
sql_password          = "MyStrongP@ssw0rd123!"   # REPLACE WITH SECURE PASSWORD
sql_db_name           = "schoolgptdb"
sql_sku_name          = "S1"                     # Basic, S0, S1, S2, S3 for different performance tiers
sql_azuread_admin_login = "admin@myschool.edu"   # REPLACE WITH YOUR ADMIN EMAIL
sql_azuread_admin_object_id = "f3885dda-10a2-41bc-bffa-3e657748ecfb"  # REPLACE WITH YOUR OBJECT ID

# Application Insights
app_insights_name = "schoolgpt-ai"

# Azure Key Vault
key_vault_name            = "schoolgptkv123"     # MUST BE GLOBALLY UNIQUE
key_vault_admin_object_id = "f3885dda-10a2-41bc-bffa-3e657748ecfb"  # REPLACE WITH YOUR OBJECT ID
